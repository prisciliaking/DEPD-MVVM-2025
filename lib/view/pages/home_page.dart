...
// This is the Domestic Shipping Cost calculation page content, previously the entire HomePage.
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    // Removed the root Scaffold and AppBar since MainWrapper provides them.
    return Stack(
      children: [
                              ...
                              builder: (context, vm, _) {
                                ...
                                if (vm.cityDestinationList.status ==
                                  ...
                                  final validIds = cities
                                      .map((c) => c.id)
                                      .toSet();
                                  final validValue = validIds.contains(
                                    selectedCityDestinationId,
                                  )
                                      ? selectedCityDestinationId
                                      : null;
